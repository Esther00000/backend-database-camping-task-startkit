...
-- 用戶王小明的購買堂數
SELECT user_id,SUM(purchased_credits)
FROM "CREDIT_PURCHASE"
WHERE user_id = (
	SELECT id
  	FROM "USER"
...
SELECT  "CREDIT_PURCHASE".user_id,("CREDIT_PURCHASE".total_credits - "COURSE_BOOKING".used_credits) AS remaining_credit
FROM (
